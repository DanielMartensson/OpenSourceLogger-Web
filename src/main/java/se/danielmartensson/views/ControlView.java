...
public class ControlView extends AppLayout {
	...
	public static int selectedSamplingTime = 100;
	...
	private HorizontalLayout createFirstRow(JobService jobService, List<IntegerField> counters) {
		...
		Select<Integer> samplingTime = new Select<Integer>(new Integer[] { 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 10000, 20000, 30000, 40000, 50000, 60000 });
